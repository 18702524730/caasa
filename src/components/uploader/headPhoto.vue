    ...
    methods: {
      ...
      inputFile(newFile, oldFile) {
        ...
        if (newFile && oldFile) {
          ...
          //上传成功
          if (this.progress == 100 && res && (res.url || res.msg)) {
...
<style lang='less'>
	.upload_wrap_photo{
		position: relative;width: 116px;height: 116px;border-radius: 58px;overflow: hidden;border:1px solid #0048A3;
		.file-uploads{opacity: 0;-ms-filter: 'progid: DXImageTransform.Microsoft.Alpha(Opacity=0)'; position: absolute;left: 0;top: 0;width: 114px;height: 114px;cursor: pointer;}
    .file-uploader{
      float:left;width: 114px;height: 114px;cursor: pointer;text-align: center;background-color: #f5f5f5;
      .tipt{
      ...
      .successImg{
      	width: 114px; height: 114px;padding:0;
      	text-align: center;
      ...
      .img-wrap{
      	position: relative;height: 100%;line-height: 114px;text-align: center;
      	.img-hover{
      		position: absolute;top: 0;left:0;width: 100%;height: 100%;display: none;background-color: rgba(0, 0, 0, 0.6);
      		p{width: 100%;height: 100%;line-height: 114px;color: #fff;font-size: 13px;}
      	}
