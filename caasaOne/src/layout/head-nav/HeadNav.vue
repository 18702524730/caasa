    ...
    <div>
        ...
        <header class="head-nav">
            ...
            <div class="menu_wrap">
                ...
                <el-menu :default-active="$route.matched[0].path" class="el-menu-demo" @select="changeMenu"
            ...
            <div class="userinfo">
                ...
                <!-- <span class='username' style="font-size:14px; cursor: default">{{name}} -->
                    <!-- <el-dropdown
                            trigger="click"
                            @command='setDialogInfo'>
                        <span class="el-dropdown-link">
                            {{this.$store.state.user.userinfo.name}}<i class="el-icon-caret-bottom el-icon--right"></i>
                        </span>
