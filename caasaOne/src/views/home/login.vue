...
<div class="loginbox">
  <div class="formbox">
      <div class="formcontent" v-if="!zhuce">
          <div class="denglubox">
            ...
            <div class="login_container" id="login_container"></div>
          </div>
      </div>
      <div v-if="zhuce" class="formcontent">
        <div class="denglubox" v-if="pcdenglu">
          <h3 class="denglu"><span v-if="yhzc" class="active">用户注册</span><span class="active" v-else>密码找回</span></h3>
          <div>
            <div class="phonebox mb27">
                <span class="itemtit">用户名：</span>
...
export default {
  ...
  mounted(){
    this.fromurl = localStorage.getItem('hdUrl') || ''
      // this.wechat()
      this.usewxlogin(this.fromurl)
